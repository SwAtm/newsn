...
echo "<tr><td><a href=".site_url('patients/get_details_pid/'.$patients1['pid']).">$patients1[pid]</a></td><td>$patients1[name].$patients1[add1].$patients1[add2]</td><td>$patients1[phone]</td></tr>";
endforeach;
echo "</table>";
?>
