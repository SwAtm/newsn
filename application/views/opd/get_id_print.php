...
$this->table->set_heading(array('data'=>'Enter ID to print', 'align'=>'center'));
echo form_open('opd/get_id_print', array('id'=>'getidprint'));
...
<script type="text/javascript" language="JavaScript">
	document.forms['getidprint'].elements['id'].focus();
	</script>
