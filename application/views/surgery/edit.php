...
endforeach;
echo "<tr><td>HIV</td><td colspan=2>".form_dropdown('hiv', array(''=>'Select', 'negative'=>'Negative', 'positivw'=>'Positive'),$surgery['hiv'])."</td></tr>";
echo "<tr><td>HBsAg</td><td colspan=2>".form_dropdown('hbsag', array(''=>'Select', 'negative'=>'Negative', 'positive'=>'Positive'),$surgery['hbsag'])."</td></tr>";
