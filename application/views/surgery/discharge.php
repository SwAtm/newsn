...
$pdf->ln(2);
$pdf->SetX($xd);
$pdf->Cell(42,5,"Age/Sex: ".$p['dob']."/".$p['sex'],0,0);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(42,5,"SICS:- ".$p['eye'],0,0,'L');
$pdf->SetFont('Arial','',12);
$pdf->cell(42,5,"DOS: ".$dos,0,1,'R');
$pdf->ln(2);
$pdf->SetX($xd);
$pdf->SetFont('Arial','',11);
$pdf->cell(64,5,"H/o DM: ".$p['dm'],0,0,'L');
//$pdf->SetX($xd);
$pdf->cell(64,5,"H/o HTN: ".$p['htn'],0,1,'L');
$pdf->ln(1);
$pdf->SetX($xd);
...
$pdf->cell(51,8, $discharge['p1']." at ".$discharge['tm1'],1,1);
